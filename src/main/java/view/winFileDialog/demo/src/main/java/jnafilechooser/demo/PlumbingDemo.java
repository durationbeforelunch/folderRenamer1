 ...
 */
package view.winFileDialog.demo.src.main.java.jnafilechooser.demo;

import static view.winFileDialog.win32.src.main.java.jnafilechooser.win32.Comdlg32.*;
import static view.winFileDialog.win32.src.main.java.jnafilechooser.win32.Ole32.*;
import static view.winFileDialog.win32.src.main.java.jnafilechooser.win32.Shell32.*;
...
import view.winFileDialog.win32.src.main.java.jnafilechooser.win32.Comdlg32.OpenFileName;
import view.winFileDialog.win32.src.main.java.jnafilechooser.win32.Shell32.BrowseInfo;
...
public class PlumbingDemo {
	public static void main(String[] args) throws Exception {
		...
		final JFrame frame = new JFrame(PlumbingDemo.class.getSimpleName());
